...
public class budgeNewtInput extends JFrame {
	...
	public budgeNewtInput() {
		...
		JLabel lbl_month = new JLabel("\uAE30\uC900 \uC6D4");
		...
		sl_panel_9.putConstraint(SpringLayout.NORTH, textField_monthInput, 36, SpringLayout.NORTH, panel_9);
		sl_panel_9.putConstraint(SpringLayout.WEST, textField_monthInput, 10, SpringLayout.WEST, panel_9);
		sl_panel_9.putConstraint(SpringLayout.EAST, textField_monthInput, -232, SpringLayout.EAST, panel_9);
		...
		sl_panel_9.putConstraint(SpringLayout.NORTH, lblNewLabel, -12, SpringLayout.NORTH, textField_monthInput);
		sl_panel_9.putConstraint(SpringLayout.WEST, lblNewLabel, 6, SpringLayout.EAST, textField_monthInput);
		sl_panel_9.putConstraint(SpringLayout.SOUTH, lblNewLabel, -26, SpringLayout.SOUTH, panel_9);
		sl_panel_9.putConstraint(SpringLayout.EAST, lblNewLabel, -153, SpringLayout.EAST, panel_9);
		...
		btn_cancel.addActionListener(new ActionListener() { // 취소버튼 클릭시 걍 예산창으로 돌아감
...
//					main(id, dateTemp);
		...
		btn_save.addActionListener(new ActionListener() { // 저장버튼 클릭시 확인창 나오게 해야함!
			public void actionPerformed(ActionEvent e) {
