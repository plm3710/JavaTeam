...
public class MenuSelect extends JFrame {
    ...
    JPanel panel_1 = new JPanel() { // panel_1 생성& 이미지넣기
       public void paintComponent(Graphics g) {
          ...
          try {
             ...
             File fileInSamePackage = new File(path + "typing_select_notext.jpg");
    ...
    lbl_typing.setFont(new Font("배달의민족 주아", Font.PLAIN, 40));
    ...
    JPanel panel_3 = new JPanel() { // panel_3 생성& 이미지넣기
       public void paintComponent(Graphics g) {
          ...
          try {
             String path = a.class.getResource("").getPath();
             File fileInSamePackage = new File(path + "budget_normal_notext.jpg");
             BufferedImage icon = ImageIO.read(fileInSamePackage);
    ...
    lbl_budget.setFont(new Font("배달의민족 주아", Font.PLAIN, 40));
    ...
    JPanel panel_5 = new JPanel() { // panel_5 생성& 이미지넣기
       public void paintComponent(Graphics g) {
          ...
          try {
             String path = a.class.getResource("").getPath();
             File fileInSamePackage = new File(path + "cal_normal.jpg");
             BufferedImage icon = ImageIO.read(fileInSamePackage);
    ...
    lbl_calendar.setFont(new Font("배달의민족 주아", Font.PLAIN, 40));
    ...
    JPanel panel_7 = new JPanel() { // panel_7 생성& 이미지넣기
       public void paintComponent(Graphics g) {
          ...
          try {
             String path = a.class.getResource("").getPath();
             File fileInSamePackage = new File(path + "statistics_select_notext.jpg");
             BufferedImage icon = ImageIO.read(fileInSamePackage);
    ...
    lbl_analysis.setFont(new Font("배달의민족 주아", Font.PLAIN, 40));
